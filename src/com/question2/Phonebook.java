...
public class Phonebook {
    public static void main(String[] args) {
        ...
        if (!dataFile.exists()) {
            System.out.println("No phonebook data file found.");
            ...
            try {
                ...
                System.out.println("Error in PhoneBook data file.");
                System.out.println("File name:  " + dataFile.getAbsolutePath());
                System.out.println("We can't continue. GOOD BYE");
                System.exit(1);
            }
        }
        ...
        if (changed) {
            ...
            try {
                ...
                System.out.println("ERROR: Can't open file for output.");
                return;
            }
            for (Map.Entry<String, String> entry : phoneBook.entrySet())
